...
class TestDataStructure(unittest.TestCase):
    ...
    def test_import_integer_lists(self):
        ds = gacf.datastructure.DataStructure(
...
class TestCorrelator(unittest.TestCase):
    def setUp(self):
        ...
        self.ds2 = gacf.datastructure.DataStructure(
...
class TestGACF(unittest.TestCase):
    ...
    def test_GACF_init(self):
        gacf_instance = GACF(self.timestamps1, self.data1)

        self.assertIsInstance(gacf_instance.data, gacf.datastructure.DataStructure)

    def test_GACF_correlation(self):

        lag_timeseries, correlations = GACF(
    ...
    def test_GACF_correlation_return_corr(self):
        ...
        self.assertIsInstance(corr, gacf.correlator.Correlator)
